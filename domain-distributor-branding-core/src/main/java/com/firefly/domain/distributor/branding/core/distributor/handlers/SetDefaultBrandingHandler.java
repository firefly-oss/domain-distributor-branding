...
public class SetDefaultBrandingHandler extends CommandHandler<SetDefaultBrandingCommand, UUID> {

    private final DistributorBrandingApi distributorBrandingApi;

    public SetDefaultBrandingHandler(DistributorBrandingApi distributorBrandingApi) {
